document.addEventListener("DOMContentLoaded", function(){
    ...
    function Mouse_hover_button(Alfa,Beta){
        ...
        Alfa.addEventListener("mouseenter", function(){
            Alfa.classList.add("Button_container_border_hover");
            Beta.classList.add("Button_container_border_hover");
        ...
        Alfa.addEventListener("mouseleave", function(){
            Alfa.classList.remove("Button_container_border_hover");
            Beta.classList.remove("Button_container_border_hover");
